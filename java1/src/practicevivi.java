...
public class practicevivi {
	 ...
	 //global variables
		...
		public static void main(String[] args) {
			...
			System.out.println("static GV a: "+practicevivi.a);
			practicevivi ref=new practicevivi();
			...
			practicevivi r1=new practicevivi(55000.85);
