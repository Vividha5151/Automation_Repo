 ...
 * overrided 3. hashCode() We can create String class object in two ways 1. by
 * using new keyword ---> object will be stored in non constant pool ---> by
 * using this we can have duplicate object also 2. by using literal ---> object
 * will be stored in String constant pool(inside heap) ---> by using this we can
 * create only unique object inside the pool
 */